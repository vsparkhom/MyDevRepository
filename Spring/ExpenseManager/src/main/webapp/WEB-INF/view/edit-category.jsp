          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit category</h5>
                <!-- Multi Columns Form -->
                <form:form cssClass="row g-3" action="saveCategory" modelAttribute="category">  
                    ...
                    <div class="text-center">
                        ...
                        <input type="button" value="Cancel" class="btn btn-secondary" onclick="window.location.href = 'management-categories'" />
                    </div>
                </form:form>
