...
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 1 expense 1', 20, 3);
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 1 expense 2', 30, 3);
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 2 expense 1', 20, 4);
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 2 expense 2', 30, 4);
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 3 expense 1', 20, 5);
insert into expenses(date, merchant, amount, category_id) values (datetime(1517510802, 'unixepoch'), 'Test Cat 3 expense 2', 30, 5);
...
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Unknown expense 6', 60, 1);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Unknown expense 7', 70, 1);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Unknown expense 8', 80, 1);

insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Other expense 6', 60, 2);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Other expense 7', 70, 2);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Other expense 8', 80, 2);

insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 1 expense 6', 60, 3);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 1 expense 7', 70, 3);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 1 expense 8', 80, 3);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 2 expense 6', 60, 4);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 2 expense 7', 70, 4);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 2 expense 8', 80, 4);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 3 expense 6', 60, 5);
insert into expenses(date, merchant, amount, category_id) values (date('now'), 'Test Cat 3 expense 7', 70, 5);
